          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M21 6h-2.267l-2.955-3.535c-.367-.44-.898-.465-1.3-.065L9.6 7H3a1 1 0 00-1 1v10a1 1 0 001 1h18a1 1 0 001-1V7a1 1 0 00-1-1zm-1 10H4V8h5l4.798-4H18.2L21 8v8z" />
                <path d="M7.5 14a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
                <path d="M15.5 14.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
                <path d="M13 17a2 2 0 100-4 2 2 0 000 4z" />
              </svg>
